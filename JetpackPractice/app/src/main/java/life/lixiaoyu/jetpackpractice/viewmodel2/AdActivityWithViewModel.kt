...
class AdActivityWithViewModel : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adViewModel = ViewModelProvider(this).get(AdViewModel::class.java)
        ...
        adManager.adListener = object : AdManageListener {
            ...
            override fun enterMainPage() {
                this@AdActivityWithViewModel.enterMainPage()
            }
        }
